...
st.title("Customer Cluster Prediction – New Data")
...
# Find nearest existing customer in scaled space
...
# Optional: visualize new customer
...
ax.scatter(
    ...
    color='red', s=100, edgecolor='black', label='New Customer'
)
